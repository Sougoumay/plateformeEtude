            ...
            <ul class="nav top-menu">
                ...
                <li id="header_inbox_bar" class="dropdown">
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <a href="index.html#">
                                <span class="photo"><img alt="avatar" src={{asset("assets/imgui-zac.jpg")}}></span>
                                <span class="subject">
                  ...
                  Hi mate, how is everything?
                        ...
                        <li>
                            <a href="index.html#">
                                <span class="photo"><img alt="avatar" src={{asset("assets/imgui-divya.jpg")}}></span>
                                <span class="subject">
                  ...
                  Hi, I need your help with this.
                        ...
                        <li>
                            <a href="index.html#">
                                <span class="photo"><img alt="avatar" src={{asset("assets/imgui-danro.jpg")}}></span>
                                <span class="subject">
                  ...
                  Love your new Dashboard.
                        ...
                        <li>
                            <a href="index.html#">
                                <span class="photo"><img alt="avatar" src={{asset("assets/imgui-sherman.jpg")}}></span>
                                <span class="subject">
    ...
    <aside>
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                <p class="centered"><a href="profile.html"><img src={{asset("assets/imgui-sam.jpg")}} class="img-circle" width="80"></a></p>
        ...
        <section class="wrapper">
            <div class="row">
                            ...
                            <div class="message-p pn">
                                ...
                                <div class="row">
                                    <div class="col-md-3 centered hidden-sm hidden-xs">
                                        <img src={{asset("assets/imgui-danro.jpg")}} class="img-circle" width="65">
                                    </div>
                                    <div class="col-md-9">
                                        <p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb">
                            ...
                            <div class="white-panel pn">
                                ...
                                <p><img src={{asset("assets/imgui-zac.jpg")}} class="img-circle" width="50"></p>
                                <p><b>Zac Snider</b></p>
                                <div class="row">
                                    <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 mb">
                            <div class="product-panel-2 pn">
                                ...
                                <img src={{asset("assets/imgproduct.jpg")}} width="200" alt="">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 mb">
                            <div class="content-panel pn">
                                <div id="profile-02">
                                    <div class="user">
                                        <img src={{asset("assets/imgfriends/fr-06.jpg")}} class="img-circle" width="80">
                                        <h4>DJ SHERMAN</h4>
                                    </div>
                                </div>
                ...
                <div class="col-lg-3 ds">
                    ...
                    <div class="desc">
                        <div class="thumb">
                            <img class="img-circle" src={{asset("assets/imgui-divya.jpg")}} width="35px" height="35px" align="">
                        </div>
                        <div class="details">
                            <p>
                    ...
                    <div class="desc">
                        <div class="thumb">
                            <img class="img-circle" src={{asset("assets/imgui-sherman.jpg")}} width="35px" height="35px" align="">
                        </div>
                        <div class="details">
                            <p>
                    ...
                    <div class="desc">
                        <div class="thumb">
                            <img class="img-circle" src={{asset("assets/imgui-danro.jpg")}} width="35px" height="35px" align="">
                        </div>
                        <div class="details">
                            <p>
                    ...
                    <div class="desc">
                        <div class="thumb">
                            <img class="img-circle" src={{asset("assets/imgui-zac.jpg")}} width="35px" height="35px" align="">
                        </div>
                        <div class="details">
                            <p>
