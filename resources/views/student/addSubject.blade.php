        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('student.accueil')}}">
                                <i class="fa fa-desktop"></i>
                                <span>Mes sujets</span>
                            </a>
                        </li>
                        <li><a href="{{route('student.prendreSujetGet',$sujet->id)}}">
                                <i class="fa fa-cogs"></i>
                                <span>Prendre sujets</span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <form role="form" class="form-horizontal style-form" method="post" action="{{route('student.addSubject')}}">
                            @csrf
