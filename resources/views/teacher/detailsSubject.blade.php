    ...
    <div class="row mt">
        <div class="col-md-12">
            ...
            <div class="content-panel">
                ...
                <label>{{$subjects->created_at}}</label>
            </div>
            <div class="content-panel">
                <label>Date de dernière modification</label>
                <label>{{$subjects->updated_at}}</label>
            </div>
            <div>
            ...
            <div class="content-panel">
                ...
                @foreach($students as $student)
                    <p>Nom :{{$student->prenom}}, Email : {{$student->email}} </p>
                @endforeach
            </div>
            <div class="content-panel">
                <a href="{{route('createTask',$subjects->id)}}"><h3>Créer une nouvelle tache</h3></a>
            </div>
            <div class="row mt">
                <div class="col-md-12">
                    <div class="content-panel">
