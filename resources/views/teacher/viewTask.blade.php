        ...
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{route('detailsSubject')}}">
                                <i class="fa fa-desktop"></i>
                                <span>Mes sujets</span>
                            </a>
                        </li>
                        <li><a href="{{route('createSubjectGet')}}">
                                <i class="fa fa-cogs"></i>
            ...
            <div class="form-panel">
                <form role="form" class="form-horizontal style-form" method="post">
                    ...
                    <div class="form-group has-success">
                        ...
                        <div class="col-lg-10">
                            <input type="text" value="{{$task->nom}}" placeholder="" id="nom" class="form-control" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group has-warning">
                        ...
                        <div class="col-lg-10">
                            <input type="number" value="{{$task->points}}"  placeholder="" id="code" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="form-group has-warning">
                        <label class="col-lg-2 control-label">Solutions soumises : </label>
                        <div class="col-lg-10">
                            <input type="number" value="{{$solutionSoumise}}"  placeholder="" id="code" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="form-group has-warning">
                        <label class="col-lg-2 control-label">Solutions evaluées : </label>
                        <div class="col-lg-10">
                            <input type="number" value="{{$solutionEvalue}}" placeholder="" id="code" class="form-control" readonly>
                        </div>
                    </div>
                </form>
            </div>
